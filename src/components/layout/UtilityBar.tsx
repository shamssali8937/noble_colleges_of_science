...
export const UtilityBar: React.FC = () => {
  return (
    <div className="bg-[#0E2A1C] text-white/90 text-xs py-2 border-b border-[#1A4230] hidden md:block">
      <Container className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-white/70">Est. 2009</span>
          <span className="text-white/30">•</span>
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="flex items-center gap-1.5 text-white/90 hover:text-white transition-colors duration-150 group"
            title="Call Noble Science College"
          >
            <Phone className="w-3.5 h-3.5 text-[#C88E2E] group-hover:scale-110 transition-transform" />
          ...
          <a
            ...
            className="flex items-center gap-1.5 text-white/80 hover:text-white transition-colors duration-150 font-urdu"
